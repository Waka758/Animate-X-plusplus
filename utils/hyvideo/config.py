...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--epochs", type=int, default=100000000000000, help="Number of epochs to train.")
    ...
    group.add_argument("--prepared_embedding", type=str, default="text_embedings/a man pray_prompt_embeds.pt",
                       help="Path to the checkpoint to resume training. It can be an experiment index to resume from "
                            "the latest checkpoint in the output directory.")
...
def add_network_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        ...
        default="HYVideo-T/2", # HYVideo-T/2-inverse
    )
    group.add_argument(
        "--latent-channels",
        type=str,
...
def add_lora_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        "--root_checkpoint_path", type=str, default=None, help="Weight path for lora model."
    )

    group.add_argument(
        "--inverse-path", type=str, default="", help="Weight path for lora model."
    )
