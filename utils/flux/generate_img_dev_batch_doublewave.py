...
prompt_template = "A {} standing like a human, with only two hind legs on the ground and two front paws held high in the air"
...
for i in range(5):
    ...
    for animal in animals:
        ...
        image.save(f"flux/flux/dev/animal_doublewave/{animal}_{i}.png")