...
prompt_template = "A anthropomorphic {} standing, with only two hind legs on the ground and two front paws on either side of the body, like a human being"
...
for i in range(5):
    ...
    for animal in animals:
        ...
        image.save(f"flux/flux/dev/animal_standing_anthropomorphic_schnell/{animal}_{i}.png")