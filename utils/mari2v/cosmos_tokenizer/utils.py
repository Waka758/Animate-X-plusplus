...
def get_filepaths(input_pattern):
...
def unpad_video_batch(batch: np.ndarray, crop_region ) -> np.ndarray:
...
def unpad_image_batch(batch: np.ndarray, crop_region ) -> np.ndarray:
